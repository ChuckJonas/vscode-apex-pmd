...
**Full Changelog**: https://github.com/ChuckJonas/vscode-apex-pmd/compare/v0.10.0...v0.11.0
...
- Bump debounce from 1.2.1 to 2.2.0 by @dependabot[bot] in [#214](https://github.com/ChuckJonas/vscode-apex-pmd/pull/214)
- Bump csv-parse from 4.16.3 to 5.6.0 by @dependabot[bot] in [#215](https://github.com/ChuckJonas/vscode-apex-pmd/pull/215)
- Bump mocha from 11.5.0 to 11.6.0 by @dependabot[bot] in [#323](https://github.com/ChuckJonas/vscode-apex-pmd/pull/323)
- Bump typescript-eslint from 8.33.0 to 8.34.1 by @dependabot[bot] in [#327](https://github.com/ChuckJonas/vscode-apex-pmd/pull/327)
- Bump mocha from 11.6.0 to 11.7.0 by @dependabot[bot] in [#329](https://github.com/ChuckJonas/vscode-apex-pmd/pull/329)
- Bump eslint from 9.28.0 to 9.29.0 by @dependabot[bot] in [#330](https://github.com/ChuckJonas/vscode-apex-pmd/pull/330)
- Bump @<!-- -->types/node from 22.15.30 to 24.0.3 by @dependabot[bot] in [#331](https://github.com/ChuckJonas/vscode-apex-pmd/pull/331)
- Bump @<!-- -->types/debounce from 1.2.1 to 1.2.4 by @dependabot[bot] in [#333](https://github.com/ChuckJonas/vscode-apex-pmd/pull/333)
- Bump eslint-plugin-prettier from 5.2.6 to 5.5.0 by @dependabot[bot] in [#334](https://github.com/ChuckJonas/vscode-apex-pmd/pull/334)
- Bump typescript-eslint from 8.34.1 to 8.35.0 by @dependabot[bot] in [#336](https://github.com/ChuckJonas/vscode-apex-pmd/pull/336)
- Bump @<!-- -->types/node from 24.0.3 to 24.0.4 by @dependabot[bot] in [#339](https://github.com/ChuckJonas/vscode-apex-pmd/pull/339)
- Bump prettier from 3.5.3 to 3.6.1 by @dependabot[bot] in [#340](https://github.com/ChuckJonas/vscode-apex-pmd/pull/340)
- Bump eslint-plugin-prettier from 5.5.0 to 5.5.1 by @dependabot[bot] in [#341](https://github.com/ChuckJonas/vscode-apex-pmd/pull/341)
- Bump mocha from 11.7.0 to 11.7.1 by @dependabot[bot] in [#342](https://github.com/ChuckJonas/vscode-apex-pmd/pull/342)
- Bump minimum version of VS Code API from 1.43.0 to 1.74.0 by @adangel in [#345](https://github.com/ChuckJonas/vscode-apex-pmd/pull/345)
- Bump PMD from 7.14.0 to 7.15.0 by @adangel in [#346](https://github.com/ChuckJonas/vscode-apex-pmd/pull/346)
...
- Bump tslint from 5.20.1 to 6.1.3 by @dependabot[bot] in [#183](https://github.com/ChuckJonas/vscode-apex-pmd/pull/183)
- Bump @<!-- -->types/glob from 7.2.0 to 8.1.0 by @dependabot[bot] in [#184](https://github.com/ChuckJonas/vscode-apex-pmd/pull/184)
- Bump webpack from 5.94.0 to 5.97.1 by @dependabot[bot] in [#193](https://github.com/ChuckJonas/vscode-apex-pmd/pull/193)
- Bump @<!-- -->types/node from 10.17.60 to 22.10.10 by @dependabot[bot] in [#210](https://github.com/ChuckJonas/vscode-apex-pmd/pull/210)
- Bump typescript from 3.8.3 to 5.7.3 by @adangel in [#211](https://github.com/ChuckJonas/vscode-apex-pmd/pull/211)
- Bump eslint and prettier by @adangel in [#212](https://github.com/ChuckJonas/vscode-apex-pmd/pull/212)
- Bump ts-loader from 8.4.0 to 9.5.2 by @dependabot[bot] in [#213](https://github.com/ChuckJonas/vscode-apex-pmd/pull/213)
- Bump mocha from 10.2.0 to 11.1.0 by @dependabot[bot] in [#216](https://github.com/ChuckJonas/vscode-apex-pmd/pull/216)
- Bump @<!-- -->vscode/test-electron from 2.3.9 to 2.4.1 by @dependabot[bot] in [#217](https://github.com/ChuckJonas/vscode-apex-pmd/pull/217)
- Bump @<!-- -->types/mocha from 10.0.1 to 10.0.10 by @dependabot[bot] in [#218](https://github.com/ChuckJonas/vscode-apex-pmd/pull/218)
- Bump webpack-cli from 5.1.4 to 6.0.1 by @dependabot[bot] in [#219](https://github.com/ChuckJonas/vscode-apex-pmd/pull/219)
- Bump @<!-- -->typescript-eslint/eslint-plugin from 8.21.0 to 8.22.0 by @dependabot[bot] in [#220](https://github.com/ChuckJonas/vscode-apex-pmd/pull/220)
- Bump @<!-- -->typescript-eslint/parser from 8.21.0 to 8.22.0 by @dependabot[bot] in [#221](https://github.com/ChuckJonas/vscode-apex-pmd/pull/221)
- Bump @<!-- -->types/node from 22.10.10 to 22.12.0 by @dependabot[bot] in [#222](https://github.com/ChuckJonas/vscode-apex-pmd/pull/222)
- Bump typescript-eslint from 8.21.0 to 8.22.0 by @dependabot[bot] in [#223](https://github.com/ChuckJonas/vscode-apex-pmd/pull/223)
- Bump @<!-- -->types/node from 22.12.0 to 22.13.0 by @dependabot[bot] in [#224](https://github.com/ChuckJonas/vscode-apex-pmd/pull/224)
- Bump typescript-eslint from 8.22.0 to 8.23.0 by @dependabot[bot] in [#225](https://github.com/ChuckJonas/vscode-apex-pmd/pull/225)
- Bump @<!-- -->types/node from 22.13.0 to 22.13.1 by @dependabot[bot] in [#226](https://github.com/ChuckJonas/vscode-apex-pmd/pull/226)
- Bump eslint from 9.19.0 to 9.20.0 by @dependabot[bot] in [#228](https://github.com/ChuckJonas/vscode-apex-pmd/pull/228)
- Bump prettier from 3.4.2 to 3.5.0 by @dependabot[bot] in [#230](https://github.com/ChuckJonas/vscode-apex-pmd/pull/230)
- Bump @<!-- -->typescript-eslint/eslint-plugin from 8.23.0 to 8.24.0 by @dependabot[bot] in [#231](https://github.com/ChuckJonas/vscode-apex-pmd/pull/231)
- Bump @<!-- -->typescript-eslint/parser from 8.23.0 to 8.24.0 by @dependabot[bot] in [#232](https://github.com/ChuckJonas/vscode-apex-pmd/pull/232)
- Bump typescript-eslint from 8.23.0 to 8.24.0 by @dependabot[bot] in [#233](https://github.com/ChuckJonas/vscode-apex-pmd/pull/233)
- Bump eslint from 9.20.0 to 9.20.1 by @dependabot[bot] in [#234](https://github.com/ChuckJonas/vscode-apex-pmd/pull/234)
- Bump @<!-- -->types/node from 22.13.1 to 22.13.2 by @dependabot[bot] in [#235](https://github.com/ChuckJonas/vscode-apex-pmd/pull/235)
- Bump @<!-- -->types/node from 22.13.2 to 22.13.4 by @dependabot[bot] in [#236](https://github.com/ChuckJonas/vscode-apex-pmd/pull/236)
- Bump prettier from 3.5.0 to 3.5.1 by @dependabot[bot] in [#237](https://github.com/ChuckJonas/vscode-apex-pmd/pull/237)
- Bump webpack from 5.97.1 to 5.98.0 by @dependabot[bot] in [#238](https://github.com/ChuckJonas/vscode-apex-pmd/pull/238)
- Bump @<!-- -->typescript-eslint/parser from 8.24.0 to 8.24.1 by @dependabot[bot] in [#239](https://github.com/ChuckJonas/vscode-apex-pmd/pull/239)
- Bump typescript-eslint from 8.24.0 to 8.25.0 by @dependabot[bot] in [#242](https://github.com/ChuckJonas/vscode-apex-pmd/pull/242)
- Bump prettier from 3.5.1 to 3.5.2 by @dependabot[bot] in [#244](https://github.com/ChuckJonas/vscode-apex-pmd/pull/244)
- Bump eslint from 9.20.1 to 9.21.0 by @dependabot[bot] in [#245](https://github.com/ChuckJonas/vscode-apex-pmd/pull/245)
- Bump @<!-- -->types/node from 22.13.4 to 22.13.5 by @dependabot[bot] in [#247](https://github.com/ChuckJonas/vscode-apex-pmd/pull/247)
- Bump eslint-config-prettier from 10.0.1 to 10.0.2 by @dependabot[bot] in [#248](https://github.com/ChuckJonas/vscode-apex-pmd/pull/248)
- Bump @<!-- -->types/node from 22.13.5 to 22.13.8 by @dependabot[bot] in [#250](https://github.com/ChuckJonas/vscode-apex-pmd/pull/250)
- Bump prettier from 3.5.2 to 3.5.3 by @dependabot[bot] in [#251](https://github.com/ChuckJonas/vscode-apex-pmd/pull/251)
- Bump @<!-- -->typescript-eslint/eslint-plugin from 8.25.0 to 8.26.0 by @dependabot[bot] in [#252](https://github.com/ChuckJonas/vscode-apex-pmd/pull/252)
- Bump typescript-eslint from 8.25.0 to 8.26.0 by @dependabot[bot] in [#253](https://github.com/ChuckJonas/vscode-apex-pmd/pull/253)
- Bump typescript from 5.7.3 to 5.8.2 by @dependabot[bot] in [#254](https://github.com/ChuckJonas/vscode-apex-pmd/pull/254)
- Bump @<!-- -->types/node from 22.13.8 to 22.13.9 by @dependabot[bot] in [#255](https://github.com/ChuckJonas/vscode-apex-pmd/pull/255)
- Bump eslint-config-prettier from 10.0.2 to 10.1.1 by @dependabot[bot] in [#256](https://github.com/ChuckJonas/vscode-apex-pmd/pull/256)
- Bump eslint from 9.21.0 to 9.22.0 by @dependabot[bot] in [#257](https://github.com/ChuckJonas/vscode-apex-pmd/pull/257)
- Bump @<!-- -->types/node from 22.13.9 to 22.13.10 by @dependabot[bot] in [#258](https://github.com/ChuckJonas/vscode-apex-pmd/pull/258)
- Bump typescript-eslint from 8.26.0 to 8.26.1 by @dependabot[bot] in [#260](https://github.com/ChuckJonas/vscode-apex-pmd/pull/260)
- Bump typescript-eslint from 8.26.1 to 8.27.0 by @dependabot[bot] in [#265](https://github.com/ChuckJonas/vscode-apex-pmd/pull/265)
- Bump @<!-- -->types/node from 22.13.10 to 22.13.11 by @dependabot[bot] in [#266](https://github.com/ChuckJonas/vscode-apex-pmd/pull/266)
- Bump eslint from 9.22.0 to 9.23.0 by @dependabot[bot] in [#268](https://github.com/ChuckJonas/vscode-apex-pmd/pull/268)
- Bump @<!-- -->types/node from 22.13.11 to 22.13.13 by @dependabot[bot] in [#269](https://github.com/ChuckJonas/vscode-apex-pmd/pull/269)
- Bump eslint-plugin-prettier from 5.2.3 to 5.2.5 by @dependabot[bot] in [#270](https://github.com/ChuckJonas/vscode-apex-pmd/pull/270)
- Bump typescript-eslint from 8.27.0 to 8.28.0 by @dependabot[bot] in [#271](https://github.com/ChuckJonas/vscode-apex-pmd/pull/271)
- Bump @<!-- -->types/node from 22.13.13 to 22.13.14 by @dependabot[bot] in [#273](https://github.com/ChuckJonas/vscode-apex-pmd/pull/273)
- Bump @<!-- -->types/node from 22.13.14 to 22.13.16 by @dependabot[bot] in [#275](https://github.com/ChuckJonas/vscode-apex-pmd/pull/275)
- Bump typescript-eslint from 8.28.0 to 8.29.0 by @dependabot[bot] in [#276](https://github.com/ChuckJonas/vscode-apex-pmd/pull/276)
- Bump @<!-- -->types/node from 22.13.16 to 22.13.17 by @dependabot[bot] in [#277](https://github.com/ChuckJonas/vscode-apex-pmd/pull/277)
- Bump @<!-- -->types/node from 22.13.17 to 22.14.0 by @dependabot[bot] in [#278](https://github.com/ChuckJonas/vscode-apex-pmd/pull/278)
- Bump eslint-plugin-prettier from 5.2.5 to 5.2.6 by @dependabot[bot] in [#279](https://github.com/ChuckJonas/vscode-apex-pmd/pull/279)
- Bump eslint from 9.23.0 to 9.24.0 by @dependabot[bot] in [#282](https://github.com/ChuckJonas/vscode-apex-pmd/pull/282)
- Bump typescript from 5.8.2 to 5.8.3 by @dependabot[bot] in [#283](https://github.com/ChuckJonas/vscode-apex-pmd/pull/283)
- Bump @<!-- -->typescript-eslint/eslint-plugin from 8.29.0 to 8.29.1 by @dependabot[bot] in [#285](https://github.com/ChuckJonas/vscode-apex-pmd/pull/285)
- Bump webpack from 5.98.0 to 5.99.5 by @dependabot[bot] in [#287](https://github.com/ChuckJonas/vscode-apex-pmd/pull/287)
- Bump eslint-config-prettier from 10.1.1 to 10.1.2 by @dependabot[bot] in [#288](https://github.com/ChuckJonas/vscode-apex-pmd/pull/288)
- Bump typescript-eslint from 8.29.0 to 8.31.0 by @dependabot[bot] in [#293](https://github.com/ChuckJonas/vscode-apex-pmd/pull/293)
- Bump @<!-- -->eslint/js from 9.24.0 to 9.27.0 by @dependabot[bot] in [#308](https://github.com/ChuckJonas/vscode-apex-pmd/pull/308)
- Bump webpack from 5.99.5 to 5.99.9 by @dependabot[bot] in [#309](https://github.com/ChuckJonas/vscode-apex-pmd/pull/309)
- Bump @<!-- -->types/node from 22.14.0 to 22.15.23 by @dependabot[bot] in [#311](https://github.com/ChuckJonas/vscode-apex-pmd/pull/311)
- Bump mocha from 11.1.0 to 11.5.0 by @dependabot[bot] in [#312](https://github.com/ChuckJonas/vscode-apex-pmd/pull/312)
- Bump eslint-config-prettier from 10.1.2 to 10.1.5 by @dependabot[bot] in [#313](https://github.com/ChuckJonas/vscode-apex-pmd/pull/313)
- Bump @<!-- -->types/node from 22.15.23 to 22.15.24 by @dependabot[bot] in [#314](https://github.com/ChuckJonas/vscode-apex-pmd/pull/314)
- Bump @<!-- -->vscode/test-electron from 2.4.1 to 2.5.2 by @dependabot[bot] in [#315](https://github.com/ChuckJonas/vscode-apex-pmd/pull/315)
- Bump typescript-eslint from 8.31.0 to 8.33.0 by @dependabot[bot] in [#316](https://github.com/ChuckJonas/vscode-apex-pmd/pull/316)
- Bump @<!-- -->types/node from 22.15.24 to 22.15.27 by @dependabot[bot] in [#317](https://github.com/ChuckJonas/vscode-apex-pmd/pull/317)
- Bump @<!-- -->eslint/js from 9.27.0 to 9.28.0 by @dependabot[bot] in [#319](https://github.com/ChuckJonas/vscode-apex-pmd/pull/319)
- Bump eslint from 9.24.0 to 9.28.0 by @dependabot[bot] in [#320](https://github.com/ChuckJonas/vscode-apex-pmd/pull/320)
- Bump @<!-- -->types/node from 22.15.27 to 22.15.30 by @dependabot[bot] in [#321](https://github.com/ChuckJonas/vscode-apex-pmd/pull/321)
